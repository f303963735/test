...
<section>
	...
	<h1 class="text-center text-white"><?php echo ($sys_title); ?></h1>
	...
	<table class="table table-bordered table-striped text-center bg-info">
	    ...
	    <tr class="info">
	        ...
	        <!-- 
	        <th class="text-center">设备激活</th>
	        <th class="text-center">玩家</th>
	        <th class="text-center">游戏次数</th>
	        <th class="text-center">收入</th>
	         -->
	        <th class="text-center">报表</th>
	    </tr>
	    </thead>
	    <tbody>
	    	<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
			            ...
			            <td>99</td>
			             -->
			            <td>
			                <a href="<?php echo U('User/logincount?appid='.$v['game_appid']);?>" class="btn btn-primary btn-sm">
