...
<section>
	...
	<div class="chart">
	    <div class="canvas" >
	    	<div>
		        <h3 class="text-primary">在线时长&nbsp;<input size="8" type="text" value="<?php echo date('Y-m-d');?>" readonly class="form_datetime time"></h3>
	    	</div>
...
var options;
	...
	function getData(time){
		var url = '/data/admin.php?s=/User/ontime.html';
