...
class MemberApi extends Api{
    ...
    public function register($account, $password){
        return $this->model->register($account,$password);
    }
    ...
    public function login($account, $password){
        return $this->model->login($account, $password);
    }
    ...
    public function login_sdk($account, $password){
        return $this->model->login_sdk($account, $password);
    }

    public function regisert_sdk($data){
        return $this->model->regisert_sdk($data);
    }
